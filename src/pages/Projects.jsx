                ...
                <div key={index} className="card-project">
                  ...
                  <div className="technologies-container">
                    {technologies.map((tech, techIndex) => (
                      <span key={techIndex} className="span-technologies">
                        {tech}
                      </span>
                    ))}
                  </div>
                  <div className="links-container">
                    <a href={repository} title="Github" target="_blank" rel="noopener noreferrer">
                      <FiGithub />
                    </a>
                    <a href={site} title="Ver aplicação" target="_blank" rel="noopener noreferrer">
                      <FiExternalLink />
                    </a>
                  </div>
                </div>
